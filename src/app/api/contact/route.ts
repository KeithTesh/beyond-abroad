      ...
      await resend.emails.send({
        ...
        html: `
          ...
          <div style="background:#ffffff;padding:28px;border:1px solid #E6F3F0;border-top:none;border-radius:0 0 8px 8px;">
            ...
            <p style="color:#777;font-size:13px;margin:0;">If you didn't expect this email, you can safely ignore it. Contact us at <a href="mailto:${CONTACT_TO}" style="color:#073D3D;">${CONTACT_TO}</a>.</p>
          </div>
